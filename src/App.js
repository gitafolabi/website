      ...
      <Suspense fallback={(<div></div>)}>
        <ThemeContext.Provider value={{theme, toggleTheme}}>
          <div className="App" id={theme} >
            ...
            <Helmet>
              <meta charSet="utf-8" />
              <title>Chellrach | Your Cloud Extension </title>
              <link rel="canonical" href="https://chellrach.com/" />
              <meta name="description" content="Copyright © 2022 Chellrach Global Limited. All rights reserved." />
            </Helmet>
